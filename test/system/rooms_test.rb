...
class RoomsTest < ApplicationSystemTestCase
  ...
  test "should create room" do
    ...
    fill_in "Booked by", with: @room.booked_by
    fill_in "Floor number", with: @room.floor_number
    fill_in "Ld", with: @room.ld
    fill_in "Lu", with: @room.lu
    fill_in "Rd", with: @room.rd
    fill_in "Ru", with: @room.ru
